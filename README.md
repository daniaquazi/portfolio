...
End-to-end data project scraping tutoring service reviews from Trustpilot, cleaning and wrangling the raw data, running sentiment analysis with TextBlob, and visualising insights in a Tableau dashboard.

Skills: web scraping, data wrangling, NLP, EDA, Tableau
